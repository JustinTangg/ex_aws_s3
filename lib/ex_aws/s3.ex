defmodule ExAws.S3 do
  ...
  @doc "Get bucket policy status"
  @spec get_bucket_policy_status(bucket :: binary) :: ExAws.Operation.S3.t()
  def get_bucket_policy_status(bucket) do
    request(:get, bucket, "/", [resource: "policyStatus"],
      parser: &ExAws.S3.Parsers.parse_bucket_policy_status/1
    )
  end
